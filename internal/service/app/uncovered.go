...
type pseudocreateChatService struct {
...
func NewPsuedoCreateChatService(tm *tx.Manager, usvc domain.UserService, csvc domain.ChatService) *pseudocreateChatService {
	return &pseudocreateChatService{
		userService: usvc,
		chatService: csvc,
		txManager:   tm,
	}
...
func (svc *pseudocreateChatService) Execute(ctx context.Context, input app.CreateChatInput) (_ app.CreateChatOutput, err error) {
...
func (svc *pseudocreateChatService) transform(chatID uuid.UUID) (out app.CreateChatOutput) {
